...
{
    void overwriteBytes(std::uint32_t& modified, const uint32_t& abcd, const uint32_t& mask);
}

namespace MD5Modified::SecondPart
{

static void a_1(uint32_t& modified, const uint32_t* abcd) {
	modified &= 0b11110101111111111111011111011111;
	modified |= 0b10000100001000000000000000000000;
}

static void d_1(uint32_t& modified, const uint32_t* abcd) {
...
static void c_1(uint32_t& modified, const uint32_t* abcd) {
...
static void b_1(uint32_t& modified, const uint32_t* abcd) {
...
static void b_2(uint32_t& modified, const uint32_t* abcd) {
...
static void a_3(uint32_t& modified, const uint32_t* abcd) {
...
static void d_3(uint32_t& modified, const uint32_t* abcd) {
	modified &= 0b11111111111110111110111111111100;
	modified |= 0b10000111100000111000001111000000;
}

static void c_3(uint32_t& modified, const uint32_t* abcd) {
...
static void b_3(uint32_t& modified, const uint32_t* abcd) {
